...
This paper would like to investigate the effect of using R [@R] with RStudio [@RStudio] as statistical computing tool to the performance of BSED Mathematics and BS Mathematics students in their data management class by means of flexible learning.
