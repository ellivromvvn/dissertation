---
title: "EFFECTS OF USING R AND RSTUDIO ON STUDENTS' PERFORMANCES IN DATA MANAGEMENT UNDER FLEXIBLE LEARNING"
...
1. To determine the performance of the students before and after using and not using R and RStudio in their Mathematics in the Modern World class.

2. To determine the effect of using R and RStudio in the performance of students in their Mathematics in the Modern World class.

3. To describe the experiences of the participants in using and not using R and RStudio in their Mathematics in the Modern World class.

4. (Develop theory, combination of coding, integration) To identify departure points as basis for policies that will lead to curriculum, instruction and assessment development with respect to statistics education in NVSU specially with flexible learning.
